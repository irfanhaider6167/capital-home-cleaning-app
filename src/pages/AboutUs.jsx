...
const AboutUs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          About Capital Cleaning & Maintenance | Cleaning Services Islamabad &
          Rawalpindi
        </title>

        <meta
          name="description"
          content="Learn about Capital Cleaning & Maintenance. We provide professional sofa cleaning, carpet cleaning, home deep cleaning, office cleaning, water tank cleaning and maintenance services in Islamabad & Rawalpindi."
        />

        <meta
          name="keywords"
          content="About Capital Cleaning, cleaning company Islamabad, cleaning company Rawalpindi, sofa cleaning Islamabad, carpet cleaning Rawalpindi, deep cleaning services"
        />
        ...
        <meta
          ...
          content="Professional cleaning and maintenance services in Islamabad & Rawalpindi."
        />
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              advanced cleaning methods to remove dirt, stains, dust and
              bacteria, providing fresh and hygienic environments for homes,
              offices and commercial spaces.
              <br />
              <br />
              We proudly serve customers in Bahria Town, DHA Islamabad, DHA
              Rawalpindi, F-6, F-7, F-8, F-10, F-11, E-11, G-10, G-11, I-8,
              Gulberg Islamabad and surrounding areas.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            ...
            >
              ...
              <p className="text-gray-600">
                To become one of the most trusted cleaning and maintenance
                service providers in Islamabad and Rawalpindi through excellent
